...
jaxtyping:
  --jaxtyping-packages=JAXTYPING_PACKAGES
                        comma separated name list of packages and modules to
                        instrument for type checking with jaxtyping. The last
                        element in the list should be the type checker to use,
                        e.g. --jaxtyping-
                        packages=foopackage,barpackage,typeguard.typechecked
