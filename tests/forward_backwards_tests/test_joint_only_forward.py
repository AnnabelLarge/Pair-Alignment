...
class TestJointOnlyForward(unittest.TestCase):
    ...
    def setUp(self):
        ...
        my_model = TKF92TransitionLogprobs(config={'num_tkf_site_classes': self.C},
                                           name='tkf92')
    ...
    def test_forward(self):
        ### pred
        forward_intermeds = joint_only_forward(self.fake_aligns,
                                               self.logprob_emit_at_indel,
                                               self.joint_logprob_emit_at_match,
                                               self.joint_logprob_transit) #(L_align, T, C, B)
